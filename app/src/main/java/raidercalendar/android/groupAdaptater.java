...
public class groupAdaptater extends ArrayAdapter<Groupe> {

    int resource;
    String response;
    Context context;
    //Initialize adapter
    public groupAdaptater(Context context, int resource, List<Groupe> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        TextView groupToken =(TextView)groupView.findViewById(R.id.GroupToken);


        //Assign value name and role
        groupName.setText(groupItem.getName());
        groupToken.setText(groupItem.getJoinToken());
